...
const AboutUs = () => {
   return (
      <div className={`${styles.paddingX} my-20 `}>
         <div className={`${styles.paddingX} relative py-20 flex flex-col md:flex-row justify-between bg-lavender`}>
            ...
            <div className='flex flex-col items-start flex-1 mr-0 md:mr-20 mb-20 md:mb-0'>
               ...
               <p className={`${styles.body1} mb-5 text-medium-gray`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <div className='flex flex-col items-start flex-1'>
               ...
               <p className={`${styles.body1} mb-5 text-medium-gray`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
         </div>
      </div>
   )
