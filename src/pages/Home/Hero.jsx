   ...
   return (
      <div className={`relative flex items-center w-full min-h-[100vh]`}>
         ...
         <div className={`${styles.paddingX} z-20 pb-[150px]`}>
            ...
            <p className={`${styles.body1} mb-2  text-[#fff]`}>By <span className='text-yellow'>James West</span> <span className='px-2'>|</span> May 23, 2022</p>
            <p className={`${styles.body1} mb-5 font-bold  text-[#fff]`}>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu <br /> fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
